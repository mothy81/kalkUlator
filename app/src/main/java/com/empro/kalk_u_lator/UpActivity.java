...
public class UpActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
        ...
        mAdapter.setOnItemClickListener(new LayerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                if (Integer.parseInt(mLayerList.get(position).getText5())==0) {
                    ...
                    Dialog dialog = new Dialog(UpActivity.this);
    ...
    private void saveData()
    {
        if (mLayerList.size()==0){
            ...
            editor.putString("task list upActivity", json);
            editor.apply();
    ...
    private void loadData()
    {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("shared preferences", MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString("task list upActivity", null);
